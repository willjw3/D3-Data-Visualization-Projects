...
var div = d3.select("#map-area").append("div")
    .attr("id", "tooltip")
    .attr("class", "tooltip")
    .style("opacity", 0);
...
d3.json(theUrl, function(error, data) {
  ...
  var legX = d3.scaleLinear()
    .domain([0, 15])
    .range([0, 350]);

  var legXAxis = d3.axisBottom(legX)
    .tickSizeOuter(0)
    ...
    svgLegend.append("g")
      .attr("transform", "translate(0," + 37 + ")")    .call(legXAxis)
  .attr("id", "legX-axis");
  ...
  var yVals = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
...
var cells = svg.selectAll('rect')
      ...
      .attr('data-temp',function(d){
        ...
        .attr('y', function(d) { return yScale(d.month+.5); })
...
.on("mouseover", function(d, i) {
     ...
     .duration(200)
     .style("opacity", .9);
     div.html(d.year + " - " + yVals[d.month] + "<br/>" + d.temp + "&deg;C" + "<br/>" + d.variance + "&deg;C")
